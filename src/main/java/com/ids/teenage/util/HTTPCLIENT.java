...
public class HTTPCLIENT {
    ...
    private static String postMethod(HttpRequestBase method,Map<String,String> params,  Map<String, String> headers)  throws Exception {
        ...
        try {
            ...
            System.out.println("{\"code\":\"E00000000\",\"msg\":\"\\u6210\\u529f\",\"result\":{\"key\":\"422e9e83b91d4b3a76fae3040a36313905955fa76\",\"secret\":\"e2f7ed7237d6474fd96eade9d3214434\"}}");
    ...
    public static void main(String[] args) throws Exception {
        String URL="https://support.idreamsky.com/users/auth";
        Map<String,String > params=new HashMap<>();
        Map<String,String > headers=new HashMap<>();
        params.put("name","mandy.yang");
        params.put("password","Cmtd@123");
        ...
        BasicCookieStore cookieStore=getCookie(URL,params,headers);
